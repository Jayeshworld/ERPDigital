<div class="header">
    ...
    <div class="header-left active">
        <a href="{{ url('/') }}" class="logo logo-normal">
            <img src="{{ asset('assets/logo/desktop-logo.png') }}" alt="Logo">
            <img src="{{ asset('assets/logo/desktop-dark.png') }}" class="white-logo" alt="Logo">
        </a>
        <a href="{{ url('/') }}" class="logo-small">
            <img src="{{ asset('assets/logo/toggle-logo.png') }}" alt="Logo">
        </a>
                            ...
                            <ul class="nav-menu">
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);"><i
                                            class="ti ti-brand-airtable"></i><span>Application</span>
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);">
                                        <i class="ti ti-layout-2"></i><span>layouts</span><span
                                            class="menu-arrow"></span>
                                    </a>
                                    <ul>
